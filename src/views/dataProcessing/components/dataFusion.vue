    ...
    <el-row :gutter="40">
      <el-col :span="12" style="border-radius: 10px; box-shadow: 2px 2px 2px 1px rgba(0, 0, 0, 0.2);">
        <div class="grid-content ep-bg-purple">
          <div class="header_1">数据融合</div>
          <div class="fileSelection">
            <div class="title">待融合数据列表</div>
            <!-- `checked` 为 true 或 false -->
            <div class="box"
              style="color: black;width:100%;height: 100px;border: 1px solid #000; overflow: auto; padding: 0 10px;">
              <el-checkbox v-model="checked" style="display: block;">xxxxxxxxxxxxx</el-checkbox>
              <el-checkbox v-model="checked" style="display: block;">xxxxxxxxxxxxx</el-checkbox>
              <el-checkbox v-model="checked" style="display: block;">xxxxxxxxxxxxx</el-checkbox>
              <el-checkbox v-model="checked" style="display: block;">xxxxxxxxxxxxx</el-checkbox>
              <el-checkbox v-model="checked" style="display: block;">xxxxxxxxxxxxx</el-checkbox>
        ...
        <div class="fuseWay">
          ...
          <el-select v-model="c_way" style="width: 100%">
            <el-option v-for="item in fuseWay_options" :key="item.value" :label="item.label" :value="item.value" />
          </el-select>
        </div>
        <div class="storePath">
        ...
        <div class="btns">
          <el-button type="primary" style="padding: 10px 40px">开始融合</el-button>
      ...
      <el-col :span="12" style="border-radius: 10px; box-shadow: 2px 2px 2px 1px rgba(0, 0, 0, 0.2);">
        <div class="grid-content ep-bg-purple">
          ...
          <div class="over_btn">
            <el-button type="primary" style="padding: 10px 41%; font-size: 18px;">数据融合完成</el-button>
          </div>
